...
graph TD
    ...
    style F fill:#ffebee,stroke:#d32f2f,color:#b71c1c
    style G fill:#e1f5ff,stroke:#0288d1,color:#01579b
    style H fill:#e1f5ff,stroke:#0288d1,color:#01579b
...
```mermaid
graph LR
    subgraph "Claude Code Auto Mode"
        A1[操作请求] --> A2[分类器评估]
        A2 -->|低风险| A3[自动执行]
        A2 -->|高风险| A4[人工确认]
        A4 -->|批准| A3
    ...
    subgraph "Codex Bypass Mode"
        B1[操作请求] --> B2[直接执行]
    end

    style A1 fill:#e3f2fd,stroke:#1565c0,color:#0d47a1
    style A2 fill:#fff9c4,stroke:#fbc02d,color:#f57f17
    style A3 fill:#e8f5e9,stroke:#388e3c,color:#1b5e20
    style A4 fill:#fff3e0,stroke:#f57c00,color:#e65100
    style B1 fill:#ffebee,stroke:#d32f2f,color:#b71c1c
    style B2 fill:#ffebee,stroke:#d32f2f,color:#b71c1c
```
...
graph TD
    ...
    style D fill:#ffe1e1,stroke:#d32f2f,color:#b71c1c
    style E fill:#fff3e0,stroke:#f57c00,color:#e65100
